...
#
# Created: Thu Mar 28 16:54:26 2013
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.batch_protein_B_label.setGeometry(QtCore.QRect(20, 130, 43, 16))
        ...
        self.batch_add_button.setGeometry(QtCore.QRect(170, 210, 100, 23))
        ...
        self.batch_protein_A_button.setGeometry(QtCore.QRect(230, 70, 31, 23))
        self.batch_protein_A_button.setText(_fromUtf8(""))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/fileopen.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.batch_protein_A_button.setIcon(icon)
        ...
        self.batch_protein_B.setGeometry(QtCore.QRect(20, 150, 211, 20))
        ...
        self.batch_protein_B_button.setGeometry(QtCore.QRect(230, 150, 31, 23))
        self.batch_protein_B_button.setText(_fromUtf8(""))
        self.batch_protein_B_button.setIcon(icon)
        ...
        self.batch_remove_button.setGeometry(QtCore.QRect(170, 240, 100, 23))
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Fixed, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.batch_protein_A_ID = QtGui.QLineEdit(self.widget_2)
        self.batch_protein_A_ID.setGeometry(QtCore.QRect(210, 90, 21, 20))
        self.batch_protein_A_ID.setObjectName(_fromUtf8("batch_protein_A_ID"))
        self.batch_protein_A_ID_label = QtGui.QLabel(self.widget_2)
        self.batch_protein_A_ID_label.setGeometry(QtCore.QRect(160, 90, 46, 13))
        self.batch_protein_A_ID_label.setObjectName(_fromUtf8("batch_protein_A_ID_label"))
        self.batch_protein_B_ID = QtGui.QLineEdit(self.widget_2)
        self.batch_protein_B_ID.setGeometry(QtCore.QRect(212, 170, 21, 20))
        self.batch_protein_B_ID.setObjectName(_fromUtf8("batch_protein_B_ID"))
        self.batch_protein_B_ID_label = QtGui.QLabel(self.widget_2)
        self.batch_protein_B_ID_label.setGeometry(QtCore.QRect(160, 170, 46, 13))
        self.batch_protein_B_ID_label.setObjectName(_fromUtf8("batch_protein_B_ID_label"))
        ...
        self.batch_output_folder_button.setIcon(icon)
        ...
        self.batch_progress_bar.setProperty("value", 0)
        ...
        self.graph_filter_amount_hi.setProperty("value", 0)
        ...
        self.graph_filter_amount_low.setProperty("value", 0)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/blank.png")), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon1.addPixmap(QtGui.QPixmap(_fromUtf8(":/icon/right-32.png")), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.protein_input_button.setIcon(icon1)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(_translate("MainWindow", "Protein Contact Mapping", None))
        self.batch_input.setTitle(_translate("MainWindow", "Protein Input", None))
        self.batch_protein_B_label.setText(_translate("MainWindow", "Protein B", None))
        self.batch_add_button.setText(_translate("MainWindow", "Add ->", None))
        self.batch_protein_A_Label.setText(_translate("MainWindow", "Protein A", None))
        self.batch_remove_button.setText(_translate("MainWindow", "Remove <-", None))
        self.batch_protein_A_ID_label.setText(_translate("MainWindow", "Chain ID", None))
        self.batch_protein_B_ID_label.setText(_translate("MainWindow", "Chain ID", None))
        self.batch_list_label.setText(_translate("MainWindow", "Mappings to process:", None))
        self.batch_options.setTitle(_translate("MainWindow", "Options", None))
        self.batch_output_folder_label.setText(_translate("MainWindow", "Output Destination", None))
        self.batch_saving_convention_label.setText(_translate("MainWindow", "Filename Convention", None))
        self.batch_saving_convention_help_label.setText(_translate("MainWindow", "%d - date, %n - protein names, %t - time, %q - batch id", None))
        self.batch_create_folder.setText(_translate("MainWindow", "Create new folder for each mapping", None))
        self.batch_open_analysis.setText(_translate("MainWindow", "Load result(s) into analysis when completed", None))
        self.batch_map_button.setText(_translate("MainWindow", "Run", None))
        self.export_box.setTitle(_translate("MainWindow", "Export", None))
        self.xls_export_button.setText(_translate("MainWindow", "Export to .xls (Excel)", None))
        self.pdb_export_button.setText(_translate("MainWindow", "Export combined .pdb", None))
        self.graphing_box.setTitle(_translate("MainWindow", "Graphing", None))
        self.graph_button.setText(_translate("MainWindow", "Graph", None))
        self.graph_type_label.setText(_translate("MainWindow", "Graph Type", None))
        self.graph_type.setItemText(0, _translate("MainWindow", "2D Map", None))
        self.graph_data.setItemText(0, _translate("MainWindow", "Residue-Residue Separation", None))
        self.graph_data.setItemText(1, _translate("MainWindow", "Lennard-Jones", None))
        self.graph_data.setItemText(2, _translate("MainWindow", "Coulombic Potential", None))
        self.graph_data_label.setText(_translate("MainWindow", "Graph Data", None))
        self.graph_filter_hi.setText(_translate("MainWindow", "Graph Ceiling", None))
        self.graph_filter_low.setText(_translate("MainWindow", "Graph Floor", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.new_analysis), _translate("MainWindow", "(New Analysis)", None))
        self.protein_input_button.setText(_translate("MainWindow", "Protein Input", None))
        self.analysis_button.setText(_translate("MainWindow", "Analysis", None))
        self.view_label.setText(_translate("MainWindow", "Views", None))
        self.quick_help_label.setText(_translate("MainWindow", "Quick Help", None))
        self.quick_help.setText(_translate("MainWindow", "In the \"Protein Input\" view, you can select protein (.pdb) and chain ID (A,B,...) interaction partner files to map to each other.", None))
        self.menuFile.setTitle(_translate("MainWindow", "File", None))
        self.menuView.setTitle(_translate("MainWindow", "View", None))
        self.menuHelp.setTitle(_translate("MainWindow", "Help", None))
        self.dockWidget.setWindowTitle(_translate("MainWindow", "Console", None))
        self.actionQuit.setText(_translate("MainWindow", "Quit", None))
        self.actionProtein_Input.setText(_translate("MainWindow", "Protein Input", None))
        self.actionAnalysis.setText(_translate("MainWindow", "Analysis", None))
        self.actionAbout.setText(_translate("MainWindow", "About...", None))
        self.actionOpen_Results.setText(_translate("MainWindow", "Open Results for Analysis", None))
